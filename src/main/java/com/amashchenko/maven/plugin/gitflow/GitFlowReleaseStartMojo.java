...
public class GitFlowReleaseStartMojo extends AbstractGitFlowMojo {
    ...
    private void validateConfiguration() throws MojoFailureException {
        if (StringUtils.isBlank(gitFlowConfig.getReleaseBranchPrefix())) {
            throw new MojoFailureException(
                    "releaseBranchPrefix is blank.");
        }
    }

    private void checkCommitMessagesX() throws MojoFailureException {
        if (StringUtils.isBlank(commitMessages.getReleaseStartMessage())) {
            throw new MojoFailureException(
                    "releaseStartMessage is blank.");
        }
        if (StringUtils.isBlank(commitMessages.getReleaseVersionUpdateMessage())) {
            throw new MojoFailureException(
                    "releaseVersionUpdateMessage is blank.");
        }
    }
